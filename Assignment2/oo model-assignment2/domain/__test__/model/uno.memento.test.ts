...
import type { RoundMemento } from '../../src/model/round'
import type { GameMemento } from '../../src/model/game'

const currentRoundMemento: RoundMemento = {
  players: ['A', 'B', 'C'],
  hands: [
    [
      { type: 'WILD' },
